...
DROP FUNCTION IF EXISTS kuntur.f_u_enrrollment_InsertInStudyProgram(inenrrollment_id character varying, user_system_id character varying, subject character varying, orgId character varying);
